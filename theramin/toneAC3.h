// ---------------------------------------------------------------------------
// toneAC3 Library - v1.0 - 01/27/2013
//
// AUTHOR/LICENSE:
...
// using the PWM timer 1 pins unlike toneAC3 which can use any two pins. Both
...
// Arduino pins. Unlike toneAC, with toneAC3 you can connect to any two pins.
...
//
// SYNTAX:
//   toneAC3( pin1, pin2, frequency [, length [, background ]] ) - Play a note.
//     Parameters:
...
// ---------------------------------------------------------------------------
  ...
  void toneAC3(uint8_t pin1, uint8_t pin2, unsigned int frequency = 0, unsigned long length = 0, uint8_t background = false);
  void noToneAC3();
#endif